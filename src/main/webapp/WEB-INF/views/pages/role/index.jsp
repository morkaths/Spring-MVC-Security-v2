<!-- filepath: c:\Users\tdvit\source\Java\Web\Spring-MVC-Security-v2-1\src\main\webapp\WEB-INF\views\pages\role\index.jsp -->
                ...
                <div class="card">
                    <div class="card-header">
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            <a href="${pageContext.request.contextPath}/admin/roles/create" class="btn btn-primary">
